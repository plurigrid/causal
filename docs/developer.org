...
- [[https://github.com/kickingvegas/causal/tree/main][main]] for releases to the general public.
- [[https://github.com/kickingvegas/causal/tree/development][development]] for staging of stable pre-release functionality.
...
Causal uses the [[https://www.gnu.org/software/emacs/manual/html_node/ert/][ERT]] framework to compose and manage tests.
...
- If it is a *new* feature, please propose an [[https://github.com/kickingvegas/causal/issues][enhancement issue]] instead.
...
- PRs must pass the test regression suite.
  - New behavior introduced in a PR should have unit tests associated with it.
    - Typically this entails exercising all items in a Transient menu. Look at usage of ~causalt-suffix-testbench-runner~ in ~causal-lib-test-utils.el~ to see how this is done.
