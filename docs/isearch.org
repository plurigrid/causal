...
#+CINDEX: isearch
#+CINDEX: I-Search
#+VINDEX: causal-isearch

Causal I-Search (library: ~causal-isearch~) is a user interface for Emacs Incremental Search ([[info:emacs#Incremental Search][emacs#Incremental Search)]].

[[file:images/causal-isearch-tmenu.png]]
...
The main menu for Causal I-Search is ~causal-isearch-tmenu~. Bind this menu to {{{kbd(C-o)}}} (or your binding of preference) in the keymap ~isearch-mode-map~ as follows in your initialization file.
...
#+VINDEX: causal-isearch-tmenu

[[file:images/causal-isearch-tmenu.png]]

The main menu for Causal I-Search is organized into the following sections:
