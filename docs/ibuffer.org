...
Causal IBuffer provides a user interface to Emacs IBuffer ([[info:emacs#Buffer Menus][emacs#Buffer Menus]]), a mode designed for managing buffers. Its top-level library is ~causal-ibuffer~.
