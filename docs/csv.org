...
Causal CSV (library: ~causal-csv~) is a user interface for ~csv-mode~, a mode for working with CSV files.

[[file:images/causal-csv-edit-screenshot.png]]
...
In your initialization file, bind the Transient ~causal-csv-tmenu~ to your key binding of preference.
...
[[file:images/causal-csv-view-screenshot.png]]
...
#+VINDEX: causal-csv-align-tmenu

The display of the CSV buffer can be controlled with the menu ~causal-csv-align-tmenu~.

[[file:images/causal-csv-align-screenshot.png]]


#+TEXINFO: @subsubheading CSV Settings
#+VINDEX: causal-csv-settings-tmenu

The menu ~causal-csv-settings-tmenu~ provides access to different ~csv-mode~ settings.

[[file:images/causal-csv-settings-screenshot.png]]


#+TEXINFO: @subsubheading CSV Unicode Symbol Support

By enabling “{{{kbd(u)}}} Use Unicode Symbols” from the Settings menu, Causal CSV will use Unicode symbols as appropriate in its menus.

[[file:images/causal-csv-edit-unicode-screenshot.png]]
