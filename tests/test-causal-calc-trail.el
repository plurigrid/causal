;;; test-causal-calc-trail.el --- Causal Trail Menu Tests  -*- lexical-binding: t; -*-
...
(ert-deftest test-causal-calc-trail-tmenu ()
  (causalt-calc-setup)
  (cl-letf
    ...
    (let* ((test-vectors '(("d" . calc-trail-display)
      ...
      (causalt-suffix-testbench-runner test-vectors
                                       #'causal-calc-trail-tmenu
                                       '(lambda () (random 5000)))))
  (causalt-calc-breakdown t t))


(provide 'test-causal-calc-trail)
;;; test-causal-calc-trail.el ends here
