;;; causal-lib-test-utils.el --- Causal Test Utils       -*- lexical-binding: t; -*-
...
;; TODO: obsolete
(defun causalt-suffix-test-vector (binding command &optional argcount)
...
(defun causalt-suffix-testcase-runner (testcases menu value-fn)
...
(provide 'causal-lib-test-utils)
;;; causal-lib-test-utils.el ends here
