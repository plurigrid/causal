;;; test-causal-calc-vector.el --- Causal Vector/Matrix Menu Tests  -*- lexical-binding: t; -*-
...
(ert-deftest test-causal-calc-vector-tmenu-integration ()
  (causalt-calc-setup)
  (causalt-run-menu-input-testcases
   'causal-calc-vector-tmenu
   '(
     ("b|" (2 3) (vec 2 3))
...
(ert-deftest test-causal-calc-vector-tmenu-extract ()
  (causalt-calc-setup)
  (calc-push-list '((vec (vec 1 4) (vec 2 3))))
  (funcall 'causal-calc-vector-tmenu)
...
(ert-deftest test-causal-calc-vector-building-tmenu-integration ()
  (causalt-calc-setup)
  (causalt-run-menu-input-testcases
   'causal-calc-vector-building-tmenu
   '(
     ;; Build
     ("|" (2 3) (vec 2 3))
...
(ert-deftest test-causal-calc-vector-arithmetic-tmenu-integration ()
  (causalt-calc-setup)
  (causalt-run-menu-input-testcases
   'causal-calc-vector-arithmetic-tmenu
   '(
...
(ert-deftest test-causal-calc-statistics-tmenu-integration ()
  (causalt-calc-setup)
  (causalt-run-menu-input-testcases
   'causal-calc-statistics-tmenu
   '(("c" ((vec 1 2)) 2)
     ("c" ((vec 1 2 (vec 3))) 3)
...
(ert-deftest test-causal-calc-set-operations-tmenu-integration ()
  (causalt-calc-setup)
  (causalt-run-menu-input-testcases
   'causal-calc-set-operations-tmenu
...
(ert-deftest test-causal-calc-map-and-reduce-tmenu-integration ()
  (causalt-calc-setup)
  (causalt-run-menu-input-testcases
   'causal-calc-map-and-reduce-tmenu
   '(
     ("m+" ((vec 1 2) 1) (vec 2 3))
     ("r+" ((vec 1 2)) 3)
     ("a+" ((vec 2 4)) 6)
...
(ert-deftest test-causal-calc--histogram ()
  (causalt-calc-setup)
...
(ert-deftest test-causal-calc-vector-tmenu ()
  (causalt-calc-setup)
  (cl-letf
    ...
    (let* ((test-vectors '(("b" . causal-calc-vector-building-tmenu)
                           ("a" . causal-calc-vector-arithmetic-tmenu)
                           ("s" . causal-calc-statistics-tmenu)
                           ("S" . causal-calc-set-operations-tmenu)
                           ("m" . causal-calc-map-and-reduce-tmenu)
                           ("l" . calc-vlength)
                           ("t" . calc-transpose)
...
(ert-deftest test-causal-calc-vector-building-tmenu ()
  (causalt-calc-setup)
  (cl-letf
...
(ert-deftest test-causal-calc-vector-arithmetic-tmenu ()
  (causalt-calc-setup)
  (cl-letf
      (((symbol-function #'calc-conj-transpose) (lambda (x) (interactive)(print "WARNING: override")))
       ...
       ((symbol-function #'causal-calc-crossp) (lambda () t))
       ((symbol-function #'causal-calc-matrixmultp) (lambda () t))
       ((symbol-function #'causal-calc-square-matrixp) (lambda () t))
       )
    (let* ((test-vectors '(
...
(ert-deftest test-causal-calc-statistics-tmenu ()
  (causalt-calc-setup)
  (cl-letf
      (((symbol-function #'calc-vector-count) (lambda (x) (interactive)(print "WARNING: override")))
...
(ert-deftest test-causal-calc-set-operations-tmenu ()
  (causalt-calc-setup)
  (cl-letf
      (
       ((symbol-function #'calc-remove-duplicates) (lambda (x) (interactive)(print "WARNING: override")))
...
(ert-deftest test-causal-calc-map-and-reduce-tmenu ()
  (causalt-calc-setup)
  (cl-letf
...
(provide 'test-causal-calc-vector)
;;; test-causal-calc-vector.el ends here
