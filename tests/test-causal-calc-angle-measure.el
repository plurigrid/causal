;;; test-causal-calc-angle-measure.el --- Causal Angle Measure Tests  -*- lexical-binding: t; -*-
...
(ert-deftest test-causal-calc-angle-measure-tmenu ()
  (causalt-calc-setup) ;; calc-number-radix
  (causalt-run-menu-assert-testcases
   'causal-calc-angle-measure-tmenu
...
(provide 'test-causal-calc-angle-measure)
