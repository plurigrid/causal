;;; test-causal-calc-units.el --- Causal Unit Menu Tests  -*- lexical-binding: t; -*-
...
(ert-deftest test-causal-calc-units-tmenu-integration ()
  (causalt-calc-setup)
  (causalt-run-menu-input-testcases
   'causal-calc-units-tmenu
...
(ert-deftest test-causal-calc-units-tmenu ()
  (causalt-calc-setup)
  (cl-letf
...
(provide 'test-causal-calc-units)
;;; test-causal-calc-units.el ends here
