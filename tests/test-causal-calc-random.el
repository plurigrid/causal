;;; test-causal-calc-random.el --- Causal Random Menu Tests -*- lexical-binding: t; -*-
...
(ert-deftest test-causal-calc-random-number-tmenu-integration ()
  (causalt-calc-setup)
  (causalt-run-menu-assert-testcases
   'causal-calc-random-number-tmenu
   '(
     ;; default m=10
     ("r" ()
      (lambda ()
...
(ert-deftest test-causal-calc-random-number-tmenu ()
  (causalt-calc-setup)
  (cl-letf
    ...
    (let* ((test-vectors '(("r" . causal-calc--random-interval-0-to-m)
                           ("c" . calc-rrandom)
                           ("a" . calc-random-again)))
...
(provide 'test-causal-calc-random)
;;; test-causal-calc-random.el ends here
