;;; causal-calc-financial.el --- Causal Financial Menu    -*- lexical-binding: t; -*-
...
(transient-define-prefix causal-calc-financial-tmenu ()
  "Causal financial menu.
\nTop-level menu of financial functions."
  [["Compound Interest"
    ("f" "Future/Present Value›" causal-calc-fin-pv-fv-tmenu)
    ("p" "Periodic Payment›" causal-calc-fin-periodic-payments-tmenu)
    ("n" "# of Payments›" causal-calc-fin-number-of-payments-tmenu)
    ("t" "# of Periods To Reach Target›" causal-calc-fin-periods-to-target-tmenu)
    ("r" "Rate of Return›" causal-calc-fin-rate-of-return-tmenu)]

   ["Percentages"
    ("%" "𝑎𝑏%" causal-calc--percent-of :transient t)
    ("P" "%" causal-calc--percent :transient t)
    ("c" "→%" calc-convert-percent :transient t)
    ("D" "Δ%" calc-percent-change :transient t)
    ("=" "=" calc-evaluate :transient t)]

   ["Display"
    ("M-s" "Stack" causal-calc-stack-display-tmenu)
  ...
  ["Discounted Cash Flow Analysis"
   ("v" "Net Present Value›" causal-calc-fin-npv-tmenu)
   ("i" "Internal Rate of Return›" causal-calc-fin-irr-tmenu)]

  ["Depreciation"
   ("d" "Depreciation›" causal-calc-fin-depreciation-tmenu)]

  causal-calc-navigation-group)

(transient-define-prefix causal-calc-fin-npv-tmenu ()
  "Causal menu to calculate net present value.
...
- `causal-calc--fin-npv'"
  ...
  [("n" "Net Present Value (1:)" causal-calc--fin-npv :transient t)]

  causal-calc-navigation-group)

(transient-define-prefix causal-calc-fin-pv-fv-tmenu ()
  "Causal menu for periodic present or future value functions.
\nMenu with argument support for the following functions:
- `causal-calc--fin-fv-periodic'
- `causal-calc--fin-fv-lump'
- `causal-calc--fin-pv-periodic'
- `causal-calc--fin-pv-lump'"
  ...
  ["Future Value"
   ("f" "Periodic" causal-calc--fin-fv-periodic :transient t)
   ("F" "Lump Sum" causal-calc--fin-fv-lump :transient t)]

  ["Present Value"
    ("p" "Periodic" causal-calc--fin-pv-periodic :transient t)
    ("P" "Lump Sum" causal-calc--fin-pv-lump :transient t)]

  causal-calc-navigation-group)



(transient-define-prefix causal-calc-fin-periodic-payments-tmenu ()
  "Causal periodic payments menu.
\nMenu with argument support for the following functions:
- `causal-calc--fin-periodic-payment'"
  ...
  ["Projected payment per period"
   ("p" "Payment" causal-calc--fin-periodic-payment :transient t)]

  causal-calc-navigation-group)

(transient-define-prefix causal-calc-fin-number-of-payments-tmenu ()
  "Causal periodic payments menu.
\nMenu with argument support for the following functions:
- `causal-calc--fin-number-of-payments'"
  ...
  ["Projected number of payments"
    ("n" "Number of Payments" causal-calc--fin-number-of-payments :transient t)]

  causal-calc-navigation-group)

(transient-define-prefix causal-calc-fin-rate-of-return-tmenu ()
  "Causal rate of return menu.
\nMenu with argument support for the following functions:
- `causal-calc--fin-rate-of-return'"
  ...
  ["Rate of Return"
   ("r" "Where payment made at end of period" causal-calc--fin-rate-of-return :transient t)]

  causal-calc-navigation-group)

(transient-define-prefix causal-calc-fin-irr-tmenu ()
  "Causal internal rate of return menu.
\nMenu with argument support for the following functions:
- `causal-calc--fin-irr'"
  ...
  [("i" "Internal Rate of Return (1:)" causal-calc--fin-irr :transient t)]

  causal-calc-navigation-group)

(transient-define-prefix causal-calc-fin-periods-to-target-tmenu ()
  "Causal periods to target menu.
\nMenu with argument support for the following functions:
- `causal-calc--fin-periods-to-reach-target'"
  ...
  ["Periods to Target"
   ("n" "Periods" causal-calc--fin-periods-to-reach-target :transient t)]

  causal-calc-navigation-group)

(transient-define-prefix causal-calc-fin-depreciation-tmenu ()
  "Causal depreciation menu.
\nMenu with argument support for the following functions:
- `causal-calc--fin-depreciation-straight-line'
- `causal-calc--fin-depreciation-sum-of-years'
- `causal-calc--fin-depreciation-double-declining-balance'"
  :value '("--period=1")
  ...
  ["Depreciation"
   ("1" "Straight Line (c, s, l)" causal-calc--fin-depreciation-straight-line :transient t)
   ("2" "Sum-of-Years Digits (c, s, l, p)" causal-calc--fin-depreciation-sum-of-years :transient t)
   ("3" "Double Declining Balance (c, s, l, p)" causal-calc--fin-depreciation-double-declining-balance :transient t)]

  causal-calc-navigation-group)

;; Wrapped Functions -----

(defun causal-calc--fin-npv ()
...
(defun causal-calc--fin-fv-periodic ()
...
(defun causal-calc--fin-pv-periodic ()
...
(defun causal-calc--fin-periodic-payment ()
...
(defun causal-calc--fin-number-of-payments ()
...
(defun causal-calc--fin-periods-to-reach-target ()
...
(defun causal-calc--fin-rate-of-return ()
...
(defun causal-calc--fin-depreciation-straight-line ()
...
- `calc-fin-sln'"
  (interactive)
  (causal-calc--fin-process-depreciation #'calc-fin-sln))

(defun causal-calc--fin-depreciation-sum-of-years ()
...
- `calc-fin-syd'"
  (interactive)
  (causal-calc--fin-process-depreciation #'calc-fin-syd))

(defun causal-calc--fin-depreciation-double-declining-balance ()
...
- `calc-fin-ddb'"
  (interactive)
  (causal-calc--fin-process-depreciation #'calc-fin-ddb))

(defun causal-calc--fin-process-depreciation (fn)
...
(provide 'causal-calc-financial)
;;; causal-calc-financial.el ends here
