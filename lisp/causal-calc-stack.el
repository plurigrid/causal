;;; causal-calc-stack.el --- Causal Stack Menu            -*- lexical-binding: t; -*-
...
(defun causal-calc-customize-kill-line-numbering ()
...
(transient-define-prefix causal-calc-stack-display-tmenu ()
  "Causal stack display menu."
  ["Justification"
   :class transient-row
  ...
  [["Truncation"
   ...
   ["Misc"
    ...
    ("k" "Customize kill line numbering"
     causal-calc-customize-kill-line-numbering :transient nil)
...
;; Wrapped Functions
(defun causal-calc--stack-roll-all ()
...
(defun causal-calc--stack-clear ()
  "Clear entire stack."
  (interactive)
  (calc-pop-stack (calc-stack-size)))

(defun causal-calc--stack-swap ()
...
(defun causal-calc--copy-as-kill ()
...
(provide 'causal-calc-stack)
;;; causal-calc-stack.el ends here
