;;; causal-calc-trail.el --- Causal Trail Menu            -*- lexical-binding: t; -*-
...
(transient-define-prefix causal-calc-trail-tmenu ()
  "Causal trail menu."
  ["Trail Commands"
   ["Display"
...
(provide 'causal-calc-trail)
;;; causal-calc-trail.el ends here
