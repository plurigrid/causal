;;; causal-bibtex.el --- Transient UI for BibTeX -*- lexical-binding: t; -*-
...
;; In your initialization file, bind the Transient `causal-bibtex-tmenu' to your
;; key binding of preference.

;; (require 'causal-bibtex) ; optional if using autoloaded menu
;; (keymap-set bibtex-mode-map "M-m" #'causal-bibtex-tmenu)

;; It is highly recommended to modify the bindings in `bibtex-mode-map' to be
;; compatible with the bindings used in `causal-bibtex-tmenu':
...
;; (keymap-set bibtex-mode-map "C-a" #'causal-bibtex-beginning-of-field)
;; (keymap-set bibtex-mode-map "C-e" #'causal-bibtex-end-of-field)
...
;;;###autoload (autoload 'causal-bibtex-tmenu "causal-bibtex" nil t)
(transient-define-prefix causal-bibtex-tmenu ()
  ...
  ["Causal BibTeX"
   ...
   [""
    ("w" "Copy v" causal-bibtex-copy-field-value :transient nil)
   ...
   [""
    ("C-a" "Begin" causal-bibtex-beginning-of-field
     :description (lambda () (causal-bibtex-unicode-get :begin-field))
     :transient t)
    ("C-e" "End" causal-bibtex-end-of-field
     :description (lambda () (causal-bibtex-unicode-get :end-field))
     :transient t)]

   [""
    ("p" "Previous" previous-line
     :description (lambda () (causal-bibtex-unicode-get :previous))
     :transient t)
    ("n" "Next" bibtex-next-field
     :description (lambda () (causal-bibtex-unicode-get :next))
     :transient t)]]
  ...
  ["Entry"
   ...
   [("<" "Begin Entry" bibtex-beginning-of-entry
     :description (lambda () (causal-bibtex-unicode-get :begin-entry))
     :transient t)
    (">" "End Entry" bibtex-end-of-entry
     :description (lambda () (causal-bibtex-unicode-get :end-entry))
     :transient t)]
  ...
  [:class transient-row
          ...
          ("," "Settings›" causal-bibtex-settings-tmenu)
          (causal-lib-quit-all)])

(provide 'causal-bibtex)
;;; causal-bibtex.el ends here
