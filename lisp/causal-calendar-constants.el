;;; causal-calendar-constants.el --- Causal Calendar Constants -*- lexical-binding: t; -*-
...
(defconst causal-calendar-unicode-db
  '((:previous . '("↑" "Previous"))
    (:next . '("↓" "Next"))
...
(defun causal-calendar-unicode-get (key)
...
plain ASCII-range string."
  (causal-lib-unicode-db-get key causal-calendar-unicode-db))

;; Transient navigation group for calendar.
(transient-define-group causal-calendar--navigation-group
  ["Navigation"
   ["Day"
    ("b" "Behind" calendar-backward-day
     :description (lambda () (causal-calendar-unicode-get :behind))
     :transient t)
    ("f" "Ahead" calendar-forward-day
     :description (lambda () (causal-calendar-unicode-get :ahead))
     :transient t)
    ("." "Today" calendar-goto-today :transient t)
    ("g" "Goto…" calendar-goto-date
     ;; :description (lambda () (format "%s…" (causal-calendar-unicode-get :goto)))
     :transient t)]
   ["Week"
    ...
    ("a" "Beginning" calendar-beginning-of-week
     :description (lambda () (causal-calendar-unicode-get :beginning))
     :transient t)
    ("e" "End" calendar-end-of-week
     :description (lambda () (causal-calendar-unicode-get :end))
     :transient t)
   ...
   ["Scroll"
    ...
    ("-" "-3 months" calendar-scroll-right-three-months
     :description (lambda () (causal-calendar-unicode-get :back-3-months))
     :transient t)
    ("+" "+3 months" calendar-scroll-left-three-months
     :description (lambda () (causal-calendar-unicode-get :forward-3-months))
     :transient t)
    ("C-l" "Redraw" calendar-redraw
     :description (lambda () (causal-calendar-unicode-get :redraw))
     :transient t)]])

;; Transient menu navigation group for calendar.
(transient-define-group causal-calendar--menu-navigation-group
  [:class transient-row
   (causal-lib-quit-one)
   ("RET" "Done" transient-quit-all)
   (causal-lib-quit-all)])

(provide 'causal-calendar-constants)
;;; causal-calendar-constants.el ends here
