;;; causal-calc-labels.el --- Causal Labels               -*- lexical-binding: t; -*-
...
(defun causal-calc-open-settings-file ()
...
;; Labels
(defun causal-calc-cmplx-or-polar-label ()
...
(defun causal-calc-number-radix-label ()
...
(defun causal-calc-matrix-mode-label ()
...
(defun causal-calc-angle-mode-label ()
  "Label for angle mode."
  (cond
   ((eq calc-angle-mode 'deg) (causal-calc-unicode-get :degrees))
   ((eq calc-angle-mode 'rad) (causal-calc-unicode-get :radians))
   ((eq calc-angle-mode 'hms) "hms")))

(defun causal-calc-complex-format-label ()
...
(defun causal-calc-float-format-label (&optional include-precision)
...
(provide 'causal-calc-labels)
;;; causal-calc-labels.el ends here
