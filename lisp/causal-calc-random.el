;;; causal-calc-random.el --- Causal Random Menu          -*- lexical-binding: t; -*-
...
(defun causal-calc--random-interval-0-to-m ()
...
(transient-define-prefix causal-calc-random-number-tmenu ()
  "Causal random number functions menu."
  :value '("-m=10")
  ["Random Number Generation\n"
   ["Natural Number"
    ("m" "𝑚" "-m=" :prompt "𝑚: "
     :reader transient-read-number-N+)
    ("r" "Natural within [𝟢..𝑚)" causal-calc--random-interval-0-to-m :transient t)]
...
(provide 'causal-calc-random)
;;; causal-calc-random.el ends here
