;;; causal-calc-vector.el --- Causal Vector Menu          -*- lexical-binding: t; -*-
...
(transient-define-prefix causal-calc-vector-tmenu ()
  "Causal vector and matrix functions top-level menu."
  ["Vector & Matrix Functions (index is 1-offset)\n"
   ["Categories"
   ("b" "Building›" causal-calc-vector-building-tmenu)
   ("a" "Arithmetic›" causal-calc-vector-arithmetic-tmenu)
   ("s" "Statistics›" causal-calc-statistics-tmenu)
   ("S" "Set Operations›" causal-calc-set-operations-tmenu)
   ("m" "Map, Reduce, Apply›" causal-calc-map-and-reduce-tmenu)]
...
(transient-define-prefix causal-calc-vector-building-tmenu ()
  "Causal vector building functions menu."
...
(transient-define-prefix causal-calc-vector-arithmetic-tmenu ()
  "Causal vector arithmetic functions menu."
  [["Arithmetic (index is 1-offset)\n"
    ...
    ("p" "RH Cross Product" calc-cross :inapt-if-not causal-calc-crossp :transient t)
    ("k" "Kronecker Product" calc-kron :inapt-if-not causal-calc-matrixmultp :transient t)]
   ["Square Matrix"
    ("&" "Inverse" calc-inv :inapt-if-not causal-calc-square-matrixp :transient t)
    ("d" "Determinant" calc-mdet :inapt-if-not causal-calc-square-matrixp  :transient t)
    ("l" "LU Decomposition" calc-mlud :inapt-if-not causal-calc-square-matrixp :transient t)
    ("T" "Trace" calc-mtrace :inapt-if-not causal-calc-square-matrixp :transient t)]
   causal-calc-operators-group]

  causal-calc-navigation-group)

;; TODO: add Transient prefix arguments n
(transient-define-prefix causal-calc-statistics-tmenu ()
  "Causal statistic functions menu."
  ["Statistics (index is 1-offset, 𝑛 is 𝟣: on stack)\n"
   ["Mean and Error"
    ...
    ("h" "Histogram…" causal-calc--histogram :transient t)
...
(transient-define-prefix causal-calc-set-operations-tmenu ()
  "Causal set functions menu."
  [["Set Operations"
    ("d" "Deduplicate" calc-remove-duplicates :transient t)
...
(transient-define-prefix causal-calc-map-and-reduce-tmenu ()
  "Causal functional operations (map, reduce, apply) menu."
...
(provide 'causal-calc-vector)
;;; causal-calc-vector.el ends here
