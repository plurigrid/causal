;;; causal-calc-radix.el --- Causal Radix Menu            -*- lexical-binding: t; -*-
...
(transient-define-prefix causal-calc-radix-tmenu ()
  "Causal radix functions menu."
...
(provide 'causal-calc-radix)
;;; causal-calc-radix.el ends here
