;;; causal-bibtex-utils.el --- Causal BibTeX Utils -*- lexical-binding: t; -*-
...
(defconst causal-bibtex-unicode-db
  '((:previous . '("↑" "Previous"))
    (:next . '("↓" "Next"))
    (:begin-entry . '("⇱" "Begin"))
    (:end-entry . '("⇲" "End"))
...
(defun causal-bibtex-unicode-get (key)
...
plain ASCII-range string."
  (causal-lib-unicode-db-get key causal-bibtex-unicode-db))

(defun causal-bibtex-beginning-of-field (&optional comma)
...
(defun causal-bibtex-end-of-field (&optional comma)
...
(defun causal-bibtex-copy-field-value (&optional comma)
...
(provide 'causal-bibtex-utils)
;;; causal-bibtex-utils.el ends here
