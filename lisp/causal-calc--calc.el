;;; causal-calc--calc.el --- Causal Wrapped Calc Functions  -*- lexical-binding: t; -*-
...
;; Wrapped Functions
;; Shortdoc
;;(define-short-documentation-group causal "Causal Shortdoc")
;;(shortdoc-add-function 'causal "Constants" '(causal-calc--pi :no-manual))

(defun causal-calc--round ()
...
(defun causal-calc--percent-change ()
...
(defun causal-calc--unstore ()
  "Unstore (clears) a stored variable.
\nComplimentary command to `causal-calc--store'.
...
(defun causal-calc--edit-variable ()
...
(defun causal-calc--copy-variable ()
...
(defun causal-calc--store-exchange ()
...
(defun causal-calc--permanent-variable ()
...
(defun causal-calc--insert-variables ()
...
(provide 'causal-calc--calc)
;;; causal-calc--calc.el ends here
