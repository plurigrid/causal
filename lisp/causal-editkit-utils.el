;;; causal-editkit-utils.el --- Causal Bookmarks Utils -*- lexical-binding: t; -*-
...
(defun causal-editkit-package-transpose-frame-installed-p ()
...
(defun causal-editkit-symbol-overlay-put ()
...
(defun causal-editkit-select-magit-command ()
  "Dynamically dispatch appropriate Magit command call given context."
  (interactive)
  (if (causal-editkit-version-controlled-p)
      (cond
...
(defun causal-editkit-select-magit-command-description ()
...
;;;###autoload (autoload 'causal-editkit-open-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-open-tmenu ()
  "Menu for ‘Open’ commands.

Commands pertaining to opening and visiting files can be accessed
from here. The Project menu `causal-editkit-project-tmenu' is
...
;;;###autoload (autoload 'causal-editkit-project-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-project-tmenu ()
  "Menu for ‘Project’ commands.

Commands pertaining to project operations can be accessed here."
  ["Project"
   :description (lambda () (causal-editkit--current-project-label))
   ["File"
...
;;;###autoload (autoload 'causal-editkit-edit-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-edit-tmenu ()
  "Menu for ‘Edit’ commands.

Commands pertaining to editing operations can be accessed here."
  ["Edit"
   [("m" "Mark›" causal-editkit-mark-tmenu)
    ("c" "Copy›" causal-editkit-copy-tmenu)
    ("k" "Kill (Cut)›" causal-editkit-kill-tmenu
     :if-not causal-editkit-buffer-read-only-p)
    ("y" "Yank (Paste)" yank
    :if-not (lambda () buffer-read-only))]

   [("t" "Transpose›" causal-editkit-transpose-tmenu
     :if-not causal-editkit-buffer-read-only-p)
    ("T" "Transform›" causal-editkit-transform-text-tmenu
     :if-not causal-editkit-buffer-read-only-p)
    ("v" "Move›" causal-editkit-move-text-tmenu
     :if-not causal-editkit-buffer-read-only-p)
    ("d" "Delete›" causal-editkit-delete-tmenu
     :if-not causal-editkit-buffer-read-only-p)]

   [("s" "Sort›" causal-editkit-sort-tmenu
     :if-not causal-editkit-buffer-read-only-p
   ...
   [("f" "Fill Paragraph" fill-paragraph
    ...
    ("a" "Align Regexp" align-regexp
     :inapt-if-not use-region-p)
    ("R" "Rectangle›" causal-editkit-rectangle-tmenu)
    ("r" "Reformat›" causal-editkit-reformat-tmenu
     :if-not (lambda () buffer-read-only))]]

  causal-editkit-navigation-group)

;;;###autoload (autoload 'causal-editkit-emoji-symbols-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-emoji-symbols-tmenu ()
...
inserting common miscellaneous symbols."
  ...
  ["Smart Quotes"
   :class transient-row
   ("'" "‘single’" causal-editkit-smart-single-quote-dwim)
   ("\"" "“double”" causal-editkit-smart-double-quote-dwim)
   ("_" "„low”" causal-editkit-smart-low-quote-dwim)
   ("c" "«comillas»" causal-editkit-smart-comillas-quote-dwim)
   ("a" "’" (lambda () (interactive) (insert "’")))
   ("Q" "Electric Quote"
    electric-quote-mode
    :description
    (lambda () (causal-lib-checkbox-label
...
;;;###autoload (autoload 'causal-editkit-mark-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-mark-tmenu ()
...
;;;###autoload (autoload 'causal-editkit-copy-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-copy-tmenu ()
  "Menu for ‘Copy’ commands.

Commands pertaining to copying can be accessed here."
  ["Copy"
   [("w" "Word" causal-editkit-copy-word)
    ("s" "Sentence" causal-editkit-copy-sentence)
    ("p" "Paragraph" causal-editkit-copy-paragraph)]
   [("b" "Balanced Expression (sexp)" causal-editkit-copy-sexp)
    ("d" "Defun" causal-editkit-copy-defun
     :if (lambda () (derived-mode-p 'prog-mode)))
...
;;;###autoload (autoload 'causal-editkit-kill-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-kill-tmenu ()
...
;;;###autoload (autoload 'causal-editkit-sort-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-sort-tmenu ()
...
;;;###autoload (autoload 'causal-editkit-transpose-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-transpose-tmenu ()
...
;;;###autoload (autoload 'causal-editkit-delete-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-delete-tmenu ()
...
;;;###autoload (autoload 'causal-editkit-move-text-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-move-text-tmenu ()
  "Menu for ‘Move’ commands.

Commands pertaining to move operations can be accessed here."
  ["Move Text"
   ("w" "Word›"  causal-editkit-move-word-tmenu)
   ("s" "Sentence›"  causal-editkit-move-sentence-tmenu)
   ("b" "Balanced Expression (sexp)›" causal-editkit-move-sexp-tmenu)]
  causal-editkit-cursor-navigation-group
  causal-editkit-navigation-group)

(transient-define-prefix causal-editkit-move-word-tmenu ()
  "Menu for ‘Move Word’ commands.

Commands pertaining to move word operations can be accessed here."
  ["Move Word"
   :class transient-row
   ("b" "Backward"  causal-editkit-move-word-backward :transient t)
   ("f" "Forward"  causal-editkit-move-word-forward :transient t)]
  causal-editkit-cursor-navigation-group
  causal-editkit-navigation-group)

(transient-define-prefix causal-editkit-move-sentence-tmenu ()
  "Menu for ‘Move Sentence’ commands.

Commands pertaining to move sentence operations can be accessed here."
  ["Move Sentence"
   :class transient-row
   ("b" "Backward"  causal-editkit-move-sentence-backward :transient t)
   ("f" "Forward"  causal-editkit-move-sentence-forward :transient t)]
  causal-editkit-cursor-navigation-group
  causal-editkit-navigation-group)

(transient-define-prefix causal-editkit-move-sexp-tmenu ()
...
can be accessed here."
  ["Move Sexp"
   :class transient-row
   ("b" "Backward"  causal-editkit-move-sexp-backward :transient t)
   ("f" "Forward"  causal-editkit-move-sexp-forward :transient t)]
  causal-editkit-cursor-navigation-group
  causal-editkit-navigation-group)

;;;###autoload (autoload 'causal-editkit-windows-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-windows-tmenu ()
  "Menu for ‘Window’ commands.

Commands pertaining to window management operations can be accessed here."

  ["Causal Window"
   :description (lambda () (format "Causal Window: %s" (buffer-name)))
   :pad-keys t
   ["Focus"
    ("o" "»" other-window
     :description (lambda () (causal-editkit-unicode-get :other-window))
     :transient t)]
   [""
    ("p" "↑" windmove-up
     :description (lambda () (causal-editkit-unicode-get :point-up))
     :transient nil)
    ("n" "↓" windmove-down
     :description (lambda () (causal-editkit-unicode-get :point-down))
     :transient nil)]
   [""
    ("b" "←" windmove-left
     :description (lambda () (causal-editkit-unicode-get :point-left))
     :transient nil)
    ("f" "→" windmove-right
     :description (lambda () (causal-editkit-unicode-get :point-right))
     :transient nil)]
   ...
   ["Swap"
    ("s" "⇄"
     window-swap-states
     :transient t
     :description (lambda () (causal-editkit-unicode-get :swap)))]
   [""
   ...
   ["Split"
    ("2" "⇩" split-window-below
     :description (lambda ()
                    (causal-editkit-unicode-get :split-window-below)))

    ("3" "⇨" split-window-horizontally
     :description (lambda ()
                    (causal-editkit-unicode-get :split-window-horizontally)))]]

  [["Delete"
    :pad-keys t
    ("1" "Other" delete-other-windows)
    ("DEL" "Delete›" causal-editkit-windows-delete-tmenu)]

   ["Resize ↕︎"
    :description (lambda () (causal-editkit-unicode-get :vertical))
    ("+" "Enlarge" enlarge-window
     :description (lambda () (causal-editkit-unicode-get :enlarge))
     :transient t)
    ("-" "Shrink" shrink-window
     :description (lambda () (causal-editkit-unicode-get :shrink))
     :transient t)
    ]

   ["Resize ↔︎"
    :description (lambda () (causal-editkit-unicode-get :horizontal))
...
;;;###autoload (autoload 'causal-editkit-windows-delete-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-windows-delete-tmenu ()
...
accessed here."
  ["Delete Window"
   ...
   [("b" "To Left" windmove-delete-left
     :description (lambda () (causal-editkit-unicode-get :window-left)))]

   [("p" "Above" windmove-delete-up
     :description (lambda () (causal-editkit-unicode-get :window-above)))
    ("n" "Below" windmove-delete-down
     :description (lambda () (causal-editkit-unicode-get :window-below)))]

   [("f" "To Right" windmove-delete-right
     :description (lambda () (causal-editkit-unicode-get :window-right)))]]

  causal-editkit-navigation-group)

;;;###autoload (autoload 'causal-editkit-bookmarks-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-bookmarks-tmenu ()
    "Menu for ‘Bookmarks’ commands.

Commands pertaining to bookmark operations can be
accessed here."
  ["Bookmarks"
   ("e" "Edit Bookmarks" causal-editkit-list-bookmarks-transient)
   ("a" "Add Bookmark…" bookmark-set-no-overwrite)
   ("J" "Jump to Bookmark…" bookmark-jump)]
  causal-editkit-navigation-group)

;;;###autoload (autoload 'causal-editkit-search-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-search-tmenu ()
...
accessed here."
  ...
  [["Search ⚙︎"
    ("s" "I-Search…" causal-editkit--isearch)
    ("S" "Search…" causal-editkit--search)]

   ["Replace ⚙︎"
    ("r" "Query Replace…" causal-editkit--query-replace)]
...
;;;###autoload (autoload 'causal-editkit-tools-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-tools-tmenu ()
...
Commands pertaining to invoking different tools can be accessed here."
  ["Tools"
   ...
   ["Almanac"
    ...
    ("tz" "Time Zone›" causal-timezone-tmenu
...
;;;###autoload (autoload 'causal-editkit-registers-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-registers-tmenu ()
...
;;;###autoload (autoload 'causal-editkit-rectangle-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-rectangle-tmenu ()
...
;;;###autoload (autoload 'causal-editkit-transform-text-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-transform-text-tmenu ()
...
;;;###autoload (autoload 'causal-editkit-macro-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-macro-tmenu ()
...
Commands pertaining to macro operations can be accessed here."
  ...
  [("I" "ⓘ Keyboard Macros" causal-editkit-macro-info)]

  causal-editkit-navigation-group)

;;;###autoload (autoload 'causal-editkit-reformat-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-reformat-tmenu ()
...
accessed here."
  ...
  ["Configure"
   ("a" "Auto-fill Mode" auto-fill-mode
     :description (lambda ()
                    (causal-lib-checkbox-label auto-fill-function "Auto-fill Mode")))
   ("d" "Double Space" causal-editkit--customize-sentence-end-double-space
     :description (lambda ()
                    (causal-lib-checkbox-label sentence-end-double-space "Double Space Sentences")))
...
;;;###autoload (autoload 'causal-editkit-narrow-tmenu "causal-editkit-utils" nil t)
(transient-define-prefix causal-editkit-narrow-tmenu ()
...
;; narrowing commands to causal-editkit-narrow-tmenu.
;;
...
;;; Functions
(defun causal-editkit-macro-info ()
  "Get Info for syntax of regexps."
  (interactive)
  (info "(emacs) Keyboard Macros"))

(defun causal-editkit-list-bookmarks-transient ()
...
(defun causal-editkit-copy-word ()
  "Copy word after point."
  (interactive)
  (mark-word)
  (kill-ring-save (region-beginning) (region-end)))

(defun causal-editkit-copy-sentence ()
...
(defun causal-editkit-copy-paragraph ()
...
(defun causal-editkit-copy-sexp ()
  "Copy sexp after point."
  (interactive)
  (mark-sexp)
  (kill-ring-save (region-beginning) (region-end)))

(defun causal-editkit-move-word-backward ()
...
(defun causal-editkit-move-word-forward ()
...
(defun causal-editkit-move-sentence-backward ()
...
(defun causal-editkit-move-sentence-forward ()
...
(defun causal-editkit-move-sexp-backward ()
...
(defun causal-editkit-move-sexp-forward ()
...
(defun causal-editkit--query-replace ()
...
(defun causal-editkit--smart-quote-dwim (open-quote close-quote)
...
(defun causal-editkit-smart-single-quote-dwim ()
  "Insert or enclose a region with smart single quotes."
  (interactive)
  (causal-editkit--smart-quote-dwim "‘" "’"))

(defun causal-editkit-smart-double-quote-dwim ()
  "Insert or enclose a region with smart double quotes."
  (interactive)
  (causal-editkit--smart-quote-dwim "“" "”"))

(defun causal-editkit-smart-low-quote-dwim ()
  "Insert or enclose a region with „”."
  (interactive)
  (causal-editkit--smart-quote-dwim "„" "”"))

(defun causal-editkit-smart-comillas-quote-dwim ()
  "Insert or enclose a region with «»."
  (interactive)
  (causal-editkit--smart-quote-dwim "«" "»"))

(defun causal-editkit--current-project-label ()
...
;;; causal-editkit-utils.el ends here
