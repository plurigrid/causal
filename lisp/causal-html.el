;;; causal-html.el --- Transient UI for HTML mode -*- lexical-binding: t; -*-
...
;; In your initialization file, bind the Transient `causal-html-tmenu' to your
;; key binding of preference.

;; (require 'causal-html) ; optional if using autoloaded menu
;; (keymap-set html-mode-map "M-m" #'causal-html-tmenu)

;; A menu dedicated to HTML tags, `causal-html-tags-tmenu', can also be bound.
...
;;;###autoload (autoload 'causal-html-tmenu "causal-html" nil t)
(transient-define-prefix causal-html-tmenu ()
  "Main Transient menu for Causal HTML.
...
- Info node `(emacs) HTML Mode'"
  ...
  ["Causal HTML"
   ...
   ["Misc"
    ...
    ("A" "Autoview" html-autoview-mode
     :description (lambda () (causal-lib-checkbox-label html-autoview-mode
                                                   "HTML Autoview"))
     :if (lambda () (derived-mode-p 'html-mode)))
    ("TAB" "Toggle Invisible Tags" sgml-tags-invisible
     :description (lambda () (causal-lib-checkbox-label sgml-tags-invisible
                                             "Invisible Tags"))
     :transient t)]
  ...
  [:class transient-row
   (causal-lib-quit-one)
   ("," "Settings" causal-html-settings-tmenu)
   ("I" "ⓘ" causal-html-info)
   ("RET" "Done" transient-quit-all)
   (causal-lib-quit-all)])


;;;###autoload (autoload 'causal-html-tags-tmenu "causal-html" nil t)
(transient-define-prefix causal-html-tags-tmenu ()
