;;; causal-elisp-utils.el --- Causal Elisp Utils -*- lexical-binding: t; -*-
...
(defconst causal-elisp-unicode-db
  '((:backward-char . '("←" "Char"))
    (:backward-sexp . '("(←)" "Sexp"))
    (:forward-char . '("→" "Char"))
    (:forward-sexp . '("(→)" "Sexp"))
...
(defun causal-elisp-unicode-get (key)
...
plain ASCII-range string."
  (causal-lib-unicode-db-get key causal-elisp-unicode-db))

(defun causal-elisp--next-sexp-raw ()
...
(provide 'causal-elisp-utils)
;;; causal-elisp-utils.el ends here
