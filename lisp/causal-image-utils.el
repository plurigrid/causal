;;; causal-image-utils.el --- Causal Image Utils     -*- lexical-binding: t; -*-
...
(defconst causal-image-unicode-db
...
(defun causal-image-unicode-get (key)
...
ASCII-range string."
  (causal-lib-unicode-db-get key causal-image-unicode-db))

(defun causal-image--resize ()
...
(defun causal-image--reset-point ()
...
(defun causal-image--indentify-verbose ()
...
(defun causal-image--resized-filename (filename resize-type modifier)
...
(defun causal-image--customize-image-cut-color ()
...
(defun causal-image--identify-label ()
...
;; Transients
(transient-define-prefix causal-image-resize-tmenu ()
  "Causal Image Resize Menu.

Menu resizing an image."
  :value '("--geometry=100%" "--as")
  ["Resize"
   :description (lambda () (format "Resize: %s" (causal-image--identify-label)))
  ...
  ["Command"
   ("r" "Resize" causal-image--resize :transient t)]
...
(provide 'causal-image-utils)
;;; causal-image-utils.el ends here
